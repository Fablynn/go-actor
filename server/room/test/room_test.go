...
func TestTexas(t *testing.T) {
	...
	// -----------加入房间------------
	t.Run("JoinRoom1 2 3", func(t *testing.T) {
	...
	// -----------买入------------
	t.Run("BuyIn1 2 3", func(t *testing.T) {
	...
	// -----------坐下------------
	t.Run("SitDown1 2 3", func(t *testing.T) {
	...
	t.Run("Bet1", func(t *testing.T) {
		mock.Request(uid1, roomId, pb.CMD_TEXAS_DO_BET_REQ, &pb.TexasDoBetReq{Chip: 800, ChairId: 1, RoomId: roomId, OperateType: int32(pb.OperateType_ALL_IN)})
	})
	t.Run("Bet2", func(t *testing.T) {
		mock.Request(uid2, roomId, pb.CMD_TEXAS_DO_BET_REQ, &pb.TexasDoBetReq{Chip: 800, ChairId: 2, RoomId: roomId, OperateType: int32(pb.OperateType_ALL_IN)})
	})
	t.Run("Bet3", func(t *testing.T) {
		mock.Request(uid3, roomId, pb.CMD_TEXAS_DO_BET_REQ, &pb.TexasDoBetReq{Chip: 800, ChairId: 3, RoomId: roomId, OperateType: int32(pb.OperateType_ALL_IN)})
	})
